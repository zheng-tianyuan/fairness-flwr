...
if __name__ == "__main__":
    ...
    min_fit_clients=6,  # Minimum number of clients to be sampled for the next round
    min_available_clients=6,  # Minimum number of clients that need to be connected to the server before a training round can start
)
