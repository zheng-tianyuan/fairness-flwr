...
class Isic2019Raw(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        dir = '/home/zty/Mdata/FLamby/flamby/datasets/fed_isic2019'
        self.dic = {
            "input_preprocessed": os.path.join(
                dir, "isic2019datasets/ISIC_2019_Training_Input_preprocessed"
            ),
...
class FedIsic2019(Isic2019Raw):
    ...
    def __init__(
        ...
        if not self.pooled:
            ...
            # output_path = "/home/zty/Mdata/FLamby/flamby/datasets/fed_isic2019/ISIC_2019_Training_Metadata_FL_new.csv"
