...
python server.py --algorithm fedrep --num_rounds 30 &
...
python fedrep_client.py --i 6 &
python fedrep_client.py --i 7 &

export CUDA_VISIBLE_DEVICES=3
python fedrep_client.py --i 8 &
python fedrep_client.py --i 9 &
